    ...
    <tbody id="eventsTableBody">
     ...
     ?>
            ...
            <tr class="event-row">
                ...
                <td><img src='../../../public/images/<?php echo htmlspecialchars($event['organizer_image']); ?>' style='width:7rem; height:3rem;'></td>
                ...
                <td class="action-icons">
                    <?php
                        ...
                        unset($eventData['organizer_image']);
                        $eventData['image'] = base64_encode($event['image']);
                        $eventData['organizer_image'] = base64_encode($event['organizer_image']);
